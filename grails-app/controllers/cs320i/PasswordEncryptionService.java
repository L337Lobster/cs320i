...
/**
 * Created by Jackson on 3/28/2017.
 */
...
public class PasswordEncryptionService {
    ...
    public byte[] getBytePassword(Blob pass) throws SQLException
    {
        int blobLength = (int) pass.length();
        byte[] blobAsBytes = pass.getBytes(1, blobLength);
        return blobAsBytes;
    }
    public Blob getBlobPassword(byte[] pass) throws SerialException, SQLException
    {
